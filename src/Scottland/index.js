...
import "./index.css"
import { taxCalculatorScotland, nationalInsuranceScotland, studentLoanScotland, statutoryPension } from '../lib';
...
export default function Scotland() {
    ...
    function handleTax(event){
        ...
        let totalTax = taxCalculatorScotland(1, totalIncome);
        let totalNi = nationalInsuranceScotland(1, totalIncome);
        let totalStudentLoan = studentLoanScotland(1, totalIncome);
