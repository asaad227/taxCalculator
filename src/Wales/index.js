...
import "./index.css"
import { nationalInsuranceWales, studentLoanWales, taxCalculatorWales, statutoryPension } from '../lib';
...
export default function Wales() {
    ...
    function handleTax(event){
        ...
        let totalTax = taxCalculatorWales(1, totalIncome);
        let totalNi = nationalInsuranceWales(1, totalIncome);
        let totalStudentLoan = studentLoanWales(1, totalIncome);
